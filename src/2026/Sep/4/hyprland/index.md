...
tags: [hyprland, nixos, tiling-window-manager, linux, omarchy]
description: Why I want to try the Hyprland tiling window manager and maybe move my work setup to a NixOS machine.
